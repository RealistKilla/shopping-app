...
export default function ProductDetailScreen() {
  ...
  return (
    <View className="flex-1 items-center justify-center bg-background">
      <Text className="text-body-lg text-on-surface">Product Detail Placeholder (Phase 2)</Text>
      <Text className="mt-sm text-body-md text-on-surface-variant">Product ID: {id}</Text>
    </View>
  );
}
